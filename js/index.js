    ...
    .map((movie) => {
      ...
      return `
        <div class="card">
          ...
          <img src="${movie.poster_path == null ? './assets/img/generic-poster.png' : 'https://image.tmdb.org/t/p/w500'+ movie.poster_path}" id="moviePic" alt="Movie Poster" width="100"px height="150px">
